...
parser.add_argument('--gpu', type=int, default=1, help='GPU to use [default: GPU 0]')#添加参数
...
parser.add_argument('--input_list_train', type=str, default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PSegNet/data/train_file_list.txt', help='Input data list file')
parser.add_argument('--input_list_test', type=str, default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PSegNet/data/test_file_list.txt', help='Input data list file')
