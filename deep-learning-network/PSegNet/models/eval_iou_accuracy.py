...
file_name = '/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PSegNet/models/out/output_filelist.txt'
...
print("ins")
print("prec:",(precision[1]),"rec:",(recall[1]),"cov:",(MUCov[1]),"wcov:",(MWCov[1]))
# semantic results
iou_list = []
...
print("precision stem:",(precision[0]),"precision leaf:",(precision[1]),"recall stem:",(recall[0]),"recall leaf:",(recall[1]),"f1 stem:",(f1[0]),"f1 leaf:",(f1[1]),"iou stem:",(iou[0]),"iou leaf:",(iou[1]))
