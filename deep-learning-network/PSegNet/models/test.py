...
parser.add_argument('--input_list', type=str, default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PSegNet/data/test_file_list.txt', help='Input data list file')
parser.add_argument('--model_path', type=str, default='/media/dawei-server/DATA - HDD8TB/wyc/kule/PSEGNET/VFS/log_test/epoch_102.ckpt', help='Path of model')
...
mean_num_pts_in_group = np.loadtxt("/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PSegNet/models/mean_ins_size.txt")#loadtxt(os.path.join(MODEL_PATH.split('/')[5], '../mean_ins_size.txt'))
