...
def estimate(area):
    LOG_DIR = '/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/ASIS_plant_master/models'
    num_classes = 6
    file_path = "/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/ASIS_plant_master/data/train_file_list.txt"
