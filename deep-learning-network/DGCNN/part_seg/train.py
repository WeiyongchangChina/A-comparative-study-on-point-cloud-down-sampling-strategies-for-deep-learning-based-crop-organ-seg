...
parser.add_argument('--input_list_train', type=str,
                    default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/dgcnn_temp1/data/train_file_list.txt',
                    help='Input data list file')
parser.add_argument('--input_list_test', type=str,
                    default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/dgcnn_temp1/data/test_file_list.txt',
                    help='Input data list file')
...
for h5_filename in train_file_list:
    cur_data,cur_sem= provider.load_h5_data_label_seg1(os.path.join(ROOT_DIR, h5_filename))
