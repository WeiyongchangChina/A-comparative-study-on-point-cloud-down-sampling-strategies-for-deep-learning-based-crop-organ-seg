...
parser.add_argument('--input_list_train', type=str,
                    default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/dgcnn/data/train_file_list.txt',
                    help='Input data list file')
parser.add_argument('--input_list_test', type=str,
                    default='/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/dgcnn/data/test_file_list.txt',
                    help='Input data list file')
