...
def estimate(area):
    LOG_DIR = '/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PlantNet_temp2/models/'.format(area)
    num_classes = 6
    file_path = "/media/dawei-server/DATA - SSD1TB/wyc/服务器训练/data_sgl/data_net_sgl/PlantNet_temp2/data/train_file_list.txt"#/home/david/ljs/PlantNet/data/train_file_list.txt
